<div class="accordion-body row" style="margin: 0!important;padding: 0!important;">
    ...
    <div class="form-group col-12 px-4 py-3 mb-3">
        <h3 for="name" class="label_custom_primary_product mb-4"> <img src="{{ asset('assets/media/icons/validando-billete.webp') }}" alt="" class="img_card_head_reportes"> Total <strong>500 Facturas</strong> </h3>
