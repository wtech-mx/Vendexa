...
<!-- Modal -->
<div class="modal fade" id="creatLiceincia" tabindex="-1" aria-labelledby="creatLiceinciaLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">

        <div class="modal-body modal_bg row">

            <form method="POST" action="{{ route('licencias.store') }}" class="z-1"  id="miFormularioLicencias" enctype="multipart/form-data">
                @csrf

                <div class="row">
                    <div class="col-10">
                        <h2 class="tiitle_modal_dark text-center mt-3">Generar Licencia</h2>
                    </div>
                ...
                <div class="row px-3">
                    ...
                    <div class="form-group col-12 mb-3 p-2">
                        ...
                        <div class="input-group ">
                            ...
                            <input name="vendedor"  type="text" class="form-control input_custom_tab_dark telefono_input @error('telefono') is-invalid @enderror" value="{{ old('telefono') }}" autocomplete="" autofocus>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-9 mb-3 " >
                        ...
                        <div class="input-group ">
                            ...
                            <input id="codigo_licencia" name="codigo" type="text" class="form-control input_custom_primary_dark" value="{{ old('codigo') }}" autocomplete="" autofocus>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-12 mb-3 p-2">
                        ...
                        <div class="input-group ">
                            ...
                            <input name="caducidad"  type="date" class="form-control input_custom_tab_dark telefono_input @error('telefono') is-invalid @enderror" value="{{ old('telefono') }}" autocomplete="" autofocus>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-12 mb-3 p-2">
                        ...
                        <div class="input-group ">
                            <textarea class="form-control textarea_custom_primary_dark"  name="comentario" value="{{ old('comentario') }}"></textarea>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $("#miFormularioLicencias").on("submit", function (event) {
    ...
    async function saveSuccessLicencia(response) {
        ...
        Swal.fire({
                ...
                focusConfirm: false,
                confirmButtonText: '<a class="btn_swalater_confirm"  style="text-decoration: none;color: #fff;" href="{{ route('licencias.index') }}" >Ver Licencias</a>',
